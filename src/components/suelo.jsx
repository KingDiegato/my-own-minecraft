...
export function Ground() {
  ...
  const handleClickGround = (event) => {
    ...
    const [x, y, z] = Object.values(event.point).map((n) => Math.ceil(n)); //* Hacemos un map con el Cubo de valor 'n' y que se coloce en la posición redondeada hacia arriba para que se ajuste a la cuadricula
